...
function content_lines(val,lines,templ,html){
	...
	$("#" + html).append(templ({"PAGE":"page"+page,"LINK":"https://dev.libraries.ou.edu/api-dsl/data_store/data/congressional/hearings/.json?query={'filter':{'TAG':'"+val._source.TAG+"'}}","TAG":val._source.TAG,"DATA":temp_data,"TITLE":val._source.TITLE,"HELD_DATE":val._source.HELD_DATE}))
