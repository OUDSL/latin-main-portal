...
function content_lines(val,lines,templ,html){
	...
	$("#" + html).append(templ({"PAGE":"page"+page,"LINK":"https://gpo.gov/fdsys/pkg/"+val._source.TAG+"/html/"+val._source.TAG+".htm","TAG","TAG":val._source.TAG,"DATA":temp_data,"TITLE":val._source.TITLE,"HELD_DATE":val._source.HELD_DATE}))
